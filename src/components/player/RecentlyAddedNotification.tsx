...
export default function RecentlyAddedNotification({
  ...
  function renderOverlay() {
    const overlay = (
      <>
        {/* Mobile only: dims the page and closes the list on tap, same as
            any other bottom-sheet backdrop. On sm+ the list is a small
            inline dropdown, no backdrop needed. */}
        <button
          type="button"
